...
class Logger
{
     ...
     *
     * @param   null|LaminasLogger     $logger     a zend log instance to log to or null to clear.
     * @throws  \InvalidArgumentException       if the given log is not a valid zend log.
     */
    public static function setLogger($logger)
    {
        if ($logger !== null && !$logger instanceof LaminasLogger) {
     ...
     *
     * @return  LaminasLogger      the zend log instance to log to.
     * @throws  Exception       if there is no log instance set.
     */
    public static function getLogger()
    {
        if (!static::$logger instanceof LaminasLogger) {
            throw new Exception(
