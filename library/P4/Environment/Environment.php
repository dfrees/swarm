...
class Environment
{
    ...
    /**
     * Gets whether multi-byte or iconv conversion is available.
     * @return bool true if either multi-byte or iconv conversion is available.
     */
    public static function supportsEncoding()
    {
        return static::supportsIconv() || static::supportsMb();
    }

    /**
     * Gets whether iconv conversion is available. This should always be available
     * in theory as it needs to be specifically excluded when building PHP to be
     * not present.
     * @return bool true if iconv conversion is available.
     */
    public static function supportsIconv()
    {
        return function_exists('iconv');
    }

    /**
     * Gets whether multi-byte conversion is available.
     * @return bool true if multi-byte conversion is available.
     */
    public static function supportsMb()
    {
        return function_exists('mb_detect_encoding') && function_exists('mb_convert_encoding');
    }
}
